...
namespace TP01_2018.Controllers
{
    public class ClientesController : Controller
    {
        private readonly TP01_2018Context _context;

        public ClientesController(TP01_2018Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'TP01_2018Context.Cliente'  is null.");
            }
