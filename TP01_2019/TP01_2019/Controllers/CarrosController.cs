...
namespace TP01_2019.Controllers
{
    public class CarrosController : Controller
    {
        ...
        public CarrosController(TP01_2019Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Numero,Equipa")] Carro carro)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'TP01_2019Context.Carro'  is null.");
            }
